...
* general run concept: `docker run --rm -t claranet/php:1.1.27-php7.2.20 <main-section> [subsection] [subsection-args, ...]`
* overview: `docker run --rm -t claranet/php:1.1.27-php7.2.20 help`
* supplied services
    - nginx
    - phpfpm
    - crond
...
Build image locally:
```sh
# generates local/claranet/php:1.1.27-php7.2.20
./bin/image.sh build
```
