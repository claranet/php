...
* general run concept: `docker run --rm -t claranet/php:1.1.34-php7.3.0 <main-section> [subsection] [subsection-args, ...]`
* overview: `docker run --rm -t claranet/php:1.1.34-php7.3.0 help`
* supplied services
    - nginx
    - phpfpm
    - crond
...
Build image locally:
```sh
# generates local/claranet/php:1.1.34-php7.3.0
./bin/image.sh build
```
