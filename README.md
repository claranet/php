...
* general run concept: `docker run --rm -t claranet/php:1.1.32-php7.2.25 <main-section> [subsection] [subsection-args, ...]`
* overview: `docker run --rm -t claranet/php:1.1.32-php7.2.25 help`
* supplied services
    - nginx
    - phpfpm
    - crond
...
Build image locally:
```sh
# generates local/claranet/php:1.1.32-php7.2.25
./bin/image.sh build
```
