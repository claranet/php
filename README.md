...
* general run concept: `docker run --rm -t claranet/php:1.1.37-php7.3.3 <main-section> [subsection] [subsection-args, ...]`
* overview: `docker run --rm -t claranet/php:1.1.37-php7.3.3 help`
* supplied services
    - nginx
    - phpfpm
    - crond
...
Build image locally:
```sh
# generates local/claranet/php:1.1.37-php7.3.3
./bin/image.sh build
```
