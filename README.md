...
* general run concept: `docker run --rm -t claranet/php:1.1.46-php7.3.12 <main-section> [subsection] [subsection-args, ...]`
* overview: `docker run --rm -t claranet/php:1.1.46-php7.3.12 help`
* supplied services
    - nginx
    - phpfpm
    - crond
...
Build image locally:
```sh
# generates local/claranet/php:1.1.46-php7.3.12
./bin/image.sh build
```
