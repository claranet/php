...
* general run concept: `docker run --rm -t claranet/php:1.1.33-php7.2.26 <main-section> [subsection] [subsection-args, ...]`
* overview: `docker run --rm -t claranet/php:1.1.33-php7.2.26 help`
* supplied services
    - nginx
    - phpfpm
    - crond
...
Build image locally:
```sh
# generates local/claranet/php:1.1.33-php7.2.26
./bin/image.sh build
```
