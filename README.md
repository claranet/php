...
* general run concept: `docker run --rm -t claranet/php:1.1.25-php7.2.18 <main-section> [subsection] [subsection-args, ...]`
* overview: `docker run --rm -t claranet/php:1.1.25-php7.2.18 help`
* supplied services
    - nginx
    - phpfpm
    - crond
...
Build image locally:
```sh
# generates local/claranet/php:1.1.25-php7.2.18
./bin/image.sh build
```
