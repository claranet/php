...
* general run concept: `docker run --rm -t claranet/php:1.1.42-php7.3.7 <main-section> [subsection] [subsection-args, ...]`
* overview: `docker run --rm -t claranet/php:1.1.42-php7.3.7 help`
* supplied services
    - nginx
    - phpfpm
    - crond
...
Build image locally:
```sh
# generates local/claranet/php:1.1.42-php7.3.7
./bin/image.sh build
```
