...
* general run concept: `docker run --rm -t claranet/php:1.1.39-php7.3.4 <main-section> [subsection] [subsection-args, ...]`
* overview: `docker run --rm -t claranet/php:1.1.39-php7.3.4 help`
* supplied services
    - nginx
    - phpfpm
    - crond
...
Build image locally:
```sh
# generates local/claranet/php:1.1.39-php7.3.4
./bin/image.sh build
```
